        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeDiplome = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeClassement = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoCinPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Redoublant1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Redoublant2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Redoublant3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AnneUni1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AnneUni2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Cne = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TypeBac = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateObtentionBac = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NoteBac = table.Column<double>(type: "float", nullable: false),
                    MentionBac = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhotoBacPath = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VilleObtention = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Candidats",
                columns: new[] { "Cne", "Admis", "Adresse", "Cin", "Conforme", "Convoque", "DateInscription", "DateNaissance", "Email", "Gsm", "ID", "LieuNaissance", "Matricule", "Nationalite", "Niveau", "Nom", "NotePreselec", "Num_dossier", "Password", "Photo", "PhotoCinPath", "Prenom", "Presence", "Sexe", "Telephone", "Verified", "Ville", "listDatt" },
                values: new object[] { "test5", false, "NKoub.Tazarin Zagora", "test5", false, false, new DateTime(2025, 1, 5, 14, 51, 31, 97, DateTimeKind.Local).AddTicks(5247), new DateTime(1995, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "xxxx@gmail.com", "0612345678", 1, "Paris", "A123", "Marocaine", 3, "xxxx", 0.0, 0, "test", "icon.jpg", null, "xxx", false, "Femme", "123-456-7890", 1, "Casablanca", false });
            ...
            migrationBuilder.InsertData(
                table: "Baccalaureats",
                columns: new[] { "Cne", "DateObtentionBac", "MentionBac", "NoteBac", "PhotoBacPath", "TypeBac" },
                values: new object[] { "test5", "2019", "Bien", 16.0, null, "SMA" });
